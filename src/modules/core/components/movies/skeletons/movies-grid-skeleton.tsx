import MobilCardSkeleton from '@/components/card/skeleton/mobile-card-skeleton'
import MovieCardSkeleton from '@/components/card/skeleton/movie-card-skeleton'
import BackButton from '@/components/common/back-button'
import { createSkeletons } from '@/utils/create-skeleton'
