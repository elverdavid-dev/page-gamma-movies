...
import FilterSection from '@/search/components/filter/filter-section'
import NotFoundSeach from '@/search/components/not-found-search'
import { searchMovies } from '@/search/services/search-movie'
