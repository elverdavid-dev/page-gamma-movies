'use client'
import PlacehoderImage from '@/components/card/placeholder-image'
import ImageWrapper from '@/components/common/image-wrapper'
import VoteAverage from '@/components/vote-average'
import type { MovieDetail } from '@/movie/types/movie-details'
import { formatRuntime } from '@/movie/utils/format-runtime'
import { baseUrlImage } from '@/utils/config'
import { formatDate, getYear } from '@/utils/date-helper'
...
const MovieInfoHero = ({ movieDetails, urlTrailer }: Props) => {
	...
	return (
		<section className="static md:absolute px-2 md:px-0  md:container md:mx-auto  inset-0 z-20 md:flex md:gap-x-5 pt-16">
			<div className="flex flex-col gap-y-3 items-center justify-center md:block pb-5 md:pb-0">
				...
				<Button
					...
					className="mt-4 bg-emerald-300 text-gray-800"
					target="_blank"
